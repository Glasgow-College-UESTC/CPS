...
![bg right:55% 90% Picture of Samples](assets/Samples.svg)
...
![w:500 center Sampling Concept](assets/sampling_idea.svg)
...
![w:500 center Aliasing Concept](assets/sampling_alias.svg)
...
![w:600 center Cosine Samples](assets/cosine_samples.svg)
...
![w:650 center Antoher sampling example](assets/cosine_different_sampling.svg)
...
![w:650 center Aliasing Rate](assets/aliasing_1.svg)
...
![w:450 center Aliasing](assets/aliasing_2.svg)
...
![w:600 center aliasing with cosine](assets/cosine_aliasing.svg)
...
![w:550 center an aliasing filter](assets/alisaing_filter.svg)
...
![w:550 center reconstruction](assets/ideal_aliasing.svg)
...
![w:550 center reconstruction](assets/interpolation.svg)
...
![w:750 center Model](assets/Comm_syste.svg)

---

# Different Kinds of Pulses

![w:550 center PM](assets/pulse_modulation.svg)

---

# <!--fit--> <span style="color:white">Digital Modulation</span>

![bg opacity:100% decorative](assets/gradient3.png)
...
![w:550 center comparison](assets/analog_digital.svg)

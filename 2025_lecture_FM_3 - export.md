...
Power (%),0.5,β=1,β=2,β=5,β=10,β=15
80,—,1,2,4,7,14
90,1,2,5,8,10,15
98,1,3,6,9,11,16
...
![bg right:50% 110% Bessel Function Plot](assets/bessel.svg)
...
![bg right:40% 100% A plot showing frequency change](assets/freq_change.svg)
...
![w:1000 center Demodulation Block Diagram](assets/block_dia.svg)
...
![bg right:40% 100% RC circuit](assets/RC.svg)
![bg right:40% 100% RC Circuit response](assets/linear_response.svg)
...
![bg right:40% 100% superheterodyne receiver](assets/Block_diagram_heterodyne.svg)
...
![bg right:40% 100% PLL block diagram](assets/Tikz_block.svg)
